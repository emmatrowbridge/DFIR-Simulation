...
This is an introductory-to-intermediate level (medium) case. The scenario is intentionally structured to require correlation across multiple sources of evidence, helping you develop core DFIR skills such as artifact analysis, process correlation, timeline reconstruction, user activity analysis, and reconstructing a sequence of events.
