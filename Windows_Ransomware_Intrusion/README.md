...
cd DFIR-Simulation-platform/Windows_Ransomware_Intrusion
```
Start by reading:
...
Make sure:
* you use exact file names, paths, timestamps, and values where applicable
